...
void splashPage(WINDOW *w)
{
	...
	attron(COLOR_PAIR(5));
	char *message[] = {"(not Pac-Man)", "Nathan Alex Sequeira (3141620)", "Nima Houshyar (xxxxxxx)", "Controls", "Use <arrows> to move player", "Press <space> to activate portal", "After collecting a powerup, press <1> or <2> to freeze half of the enemies", "Press <P> to pause", "Press <Q> to quit ", "Press <E> to start easy", "Press <H> to start hard"};
	int y, x;
	attron(COLOR_PAIR(5));
	y = 0.367 * MAX_Y;
